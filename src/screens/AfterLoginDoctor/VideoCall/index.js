...
const doctors = [
  {
    _id: '5f867928cd222d191a1ab71a',
    full_name: 'Minh ahihi',
  },
  {
    _id: '5f8595fde58e1b145a314f21',
    full_name: 'Nguyễn Văn Tuấn',
  },
  {
    _id: '5f8557520bf88f0efadc1044',
    full_name: 'Tran Tuan',
  },
];
    ...
    return (
      <MView>
        ...
        <Text style={{color: COLOR_GREEN, margin: 10}}>
          Hướng dẫn: Bác sĩ hãy giữ màn hình điện thoại trong màn hình này để
          không bỏ lỡ cuộc gọi từ bệnh nhân
        </Text>
        <Text
          style={{
