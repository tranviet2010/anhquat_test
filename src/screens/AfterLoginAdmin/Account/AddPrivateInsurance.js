...
const expireDate = require("../../../assets/img/img_account/thoi_han_thebh.png")

export default class AddPrivateInsurance extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <MView>
        ...
        <Input
          ...
          leftIcon={this.customLeftIcon(expireDate)}
        />
